...
function Login() {
  ...
  return (
    <div className='w-full h-screen  '>
        <img className='fixed w-full h-full object-cover ' 
          ...
          <div className='max-w-[450px] h-[600px] mx-auto bg-black/70 text-white '>
             <div className='max-w-[320px] mx-auto py-16 '>
               ...
               <form onSubmit={handleLogin} className='w-full flex flex-col py-4'>
                 ...
                 <button className='bg-red-600 rounded py-3 my-6 font-bold'>SignIn</button>
                 <div className='flex justify-between items-center text-sm text-gray-600 '>
                    <p><input className='mr-2' type="checkbox" />Remember Me</p>
                    <p>Need Help</p>
                 </div>
                 <p onClick={()=>{navigate('/signup')}} className='py-4 cursor-pointer '><span className='text-gray-600'>New  to Netflix?</span>
                SignUp
                 </p>
               </form>
             </div>
